...
class ClipboardMonitorService : Service() {
    companion object {
        ...
        private const val CHANNEL_ID = "tetherkids_clipboard"
    ...
    private fun createNotification(text: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle("Tether Kids").setContentText(text).setSmallIcon(android.R.drawable.ic_menu_edit).setContentIntent(pi).setOngoing(true).setPriority(NotificationCompat.PRIORITY_LOW).build()
    }
}
