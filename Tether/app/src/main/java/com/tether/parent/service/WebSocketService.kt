package com.tether.parent.service
...
import com.tether.parent.ui.dashboard.MainActivity
...
class WebSocketService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "tether_websocket"
        private const val CHANNEL_NAME = "Tether Connection"
    }

    override fun onCreate() {
        super.onCreate()
        createNotificationChannel()
        startForeground(NOTIFICATION_ID, createNotification("Memulai Tether..."))
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Koneksi background Tether"
                setShowBadge(false)
            }
