...
class CallLogService : Service() {
    companion object {
        ...
        private const val CHANNEL_ID = "tetherkids_calllog"
    ...
    private fun createNotification(text: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle("Tether Kids").setContentText(text).setSmallIcon(android.R.drawable.ic_menu_call).setContentIntent(pi).setOngoing(true).setPriority(NotificationCompat.PRIORITY_LOW).build()
    }
}
