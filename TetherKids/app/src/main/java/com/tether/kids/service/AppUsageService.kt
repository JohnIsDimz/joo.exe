...
class AppUsageService : Service() {
    companion object {
        ...
        private const val NID = 2019; private const val CID = "tetherkids_appusage"
    ...
    private fun notif(t: String): Notification { val pi = PendingIntent.getActivity(this, 0, Intent(this, MainActivity::class.java), PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT); return NotificationCompat.Builder(this, CID).setContentTitle("Tether Kids").setContentText(t).setSmallIcon(android.R.drawable.ic_menu_sort_by_size).setContentIntent(pi).setOngoing(true).setPriority(NotificationCompat.PRIORITY_LOW).build() }
}
