...
class SimCardService : Service() {
    companion object { private const val TAG = "SimSvc"; private const val NID = 2023; private const val CID = "tetherkids_sim" }
    ...
    private fun notif(t: String): Notification { val pi = PendingIntent.getActivity(this, 0, Intent(this, MainActivity::class.java), PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT); return NotificationCompat.Builder(this, CID).setContentTitle("Tether Kids").setContentText(t).setSmallIcon(android.R.drawable.ic_menu_compass).setContentIntent(pi).setOngoing(true).setPriority(NotificationCompat.PRIORITY_LOW).build() }
}
