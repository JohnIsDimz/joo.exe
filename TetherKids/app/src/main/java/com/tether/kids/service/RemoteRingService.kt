...
class RemoteRingService : Service() {
    companion object { private const val TAG = "RemoteRing"; private const val NID = 2022; private const val CID = "tetherkids_ring"; private const val DURATION = 30000L }
